...
set FILE_PATH=bin
set FILE_FIRMWARE_PATH=%FILE_PATH%\FW_LOGO_V4_T2
set SIGN_PATH=%FILE_PATH%\FW_LOGO_V4\signtool
...
call .\bat\MakeUpdate_FW_LOGO_V4_T2.bat %FILE_DLOAD_ID% %SOFTWARE_VER% %FILE_PRODUCT_NAME%