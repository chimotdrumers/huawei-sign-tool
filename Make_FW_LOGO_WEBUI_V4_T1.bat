...
set FILE_PATH=bin
set FILE_FIRMWARE_PATH=%FILE_PATH%\FW_LOGO_WEBUI_V4_T1
...
call .\bat\MakeUpdate_FW_LOGO_WEBUI_V4_T1.bat %FILE_DLOAD_ID% %SOFTWARE_VER% %FILE_PRODUCT_NAME% %WEBUI_VER%
pause