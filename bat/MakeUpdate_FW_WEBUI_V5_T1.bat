...
@if not exist %FILE_NAME% goto usage7
set FILE_NAME=06-00220000-VxWorks_R11.bin
@if not exist %FILE_NAME% goto usage7
set FILE_NAME=07-00240000-DSP_R11.bin
@if not exist %FILE_NAME% goto usage7 
set FILE_NAME=08-00280000-HIFI_R11.bin
@if not exist %FILE_NAME% goto usage7
set FILE_NAME=09-00250000-Nvdload_R11.bin
@if not exist %FILE_NAME% goto usage7
set FILE_NAME=10-00590000-System.bin
@if not exist %FILE_NAME% goto usage7
set FILE_NAME=11-005a0000-APP.bin
@if not exist %FILE_NAME% goto usage7
set FILE_NAME=12-005b0000-WEBUI.bin
@if not exist %FILE_NAME% goto usage7
...
@ren *VxWorks_R11*.bin 06-00220000-VxWorks_R11.bin
@ren *DSP_R11*.bin 07-00240000-DSP_R11.bin
@ren *HIFI_R11*.bin 08-00280000-HIFI_R11.bin
@ren *Nvdload_R11*.bin 09-00250000-Nvdload_R11.bin
@ren *System*.bin 10-00590000-System.bin
@ren *APP*.bin 11-005a0000-APP.bin
...
sign.exe ./xml/packet_fw_webui_v5_T1.xml -p %1 %2 %4
...
C:\Python25\python compress.py c ./Images/06-00220000-VxWorks_R11.bin ./%ZLIB_FILE_TEMP%/06-00220000-VxWorks_R11.zlib 9
C:\Python25\python compress.py c ./Images/07-00240000-DSP_R11.bin ./%ZLIB_FILE_TEMP%/07-00240000-DSP_R11.zlib 9
C:\Python25\python compress.py c ./Images/08-00280000-HIFI_R11.bin ./%ZLIB_FILE_TEMP%/08-00280000-HIFI_R11.zlib 9
C:\Python25\python compress.py c ./Images/09-00250000-Nvdload_R11.bin ./%ZLIB_FILE_TEMP%/09-00250000-Nvdload_R11.zlib 9
C:\Python25\python compress.py c ./Images/10-00590000-System.bin ./%ZLIB_FILE_TEMP%/10-00590000-System.zlib 9
C:\Python25\python compress.py c ./Images/11-005a0000-APP.bin ./%ZLIB_FILE_TEMP%/11-005a0000-APP.zlib 9
C:\Python25\python compress.py c ./Images/12-005b0000-WEBUI.bin ./%ZLIB_FILE_TEMP%/12-005b0000-WEBUI.zlib 9
...
merge.exe ./xml/packet_fw_webui_v5_T1.xml -p :%1:%2 %3_UPDATE_%2.BIN
merge.exe ./xml/packet_fw_webui_V5_zip_T1.xml -p :%1:%2 %3_UPDATE_%2.ZIP
