...
@if not exist %FILE_NAME% goto usage5
set FILE_NAME=05-00290000-Teeos.bin
@if not exist %FILE_NAME% goto usage5
set FILE_NAME=06-00090000-Kernel_R11.bin
@if not exist %FILE_NAME% goto usage5
set FILE_NAME=07-001e0000-Modem_fw.bin
@if not exist %FILE_NAME% goto usage5 
set FILE_NAME=08-00250000-Nvdload_R11.bin
@if not exist %FILE_NAME% goto usage5
set FILE_NAME=09-00130000-Logo.bin
@if not exist %FILE_NAME% goto usage5
set FILE_NAME=10-00590000-System.bin
@if not exist %FILE_NAME% goto usage5
set FILE_NAME=11-005a0000-APP.bin
@if not exist %FILE_NAME% goto usage5
set FILE_NAME=12-000a0000-Oeminfo.bin
@if not exist %FILE_NAME% goto usage5
set FILE_NAME=13-000b0000-CDROMISO.bin
@if not exist %FILE_NAME% goto usage5
...
sign.exe ./xml/packet_fw_iso_v5_T1.xml -p %1 %2 %4
...
C:\Python25\python compress.py c ./Images/05-00290000-Teeos.bin ./%ZLIB_FILE_TEMP%/05-00290000-Teeos.zlib 9
C:\Python25\python compress.py c ./Images/06-00090000-Kernel_R11.bin ./%ZLIB_FILE_TEMP%/06-00090000-Kernel_R11.zlib 9
C:\Python25\python compress.py c ./Images/07-001e0000-Modem_fw.bin ./%ZLIB_FILE_TEMP%/07-001e0000-Modem_fw.zlib 9
C:\Python25\python compress.py c ./Images/08-00250000-Nvdload_R11.bin ./%ZLIB_FILE_TEMP%/08-00250000-Nvdload_R11.zlib 9
C:\Python25\python compress.py c ./Images/09-00130000-Logo.bin ./%ZLIB_FILE_TEMP%/09-00130000-Logo.zlib 9
...
C:\Python25\python compress.py c ./Images/12-000a0000-Oeminfo.bin ./%ZLIB_FILE_TEMP%/12-000a0000-Oeminfo.zlib 9
C:\Python25\python compress.py c ./Images/13-000b0000-CDROMISO.bin ./%ZLIB_FILE_TEMP%/13-000b0000-CDROMISO.zlib 9

@REM delete all mbn, bin files in the current directory
@if exist *.mbn del /f /a *.mbn
@if exist *.bin del /f /a *.bin

merge.exe ./xml/packet_fw_iso_V5_T1.xml -p :%1:%2 %3_UPDATE_%2.BIN
merge.exe ./xml/packet_fw_iso_v5_zip_T1.xml -p :%1:%2 %3_UPDATE_%2.ZIP
