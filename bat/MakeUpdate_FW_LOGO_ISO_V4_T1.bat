...
sign.exe ./xml/packet_fw_logo_iso_V4_T1.xml -p %1 %2 %3 %5 %4
...
merge.exe ./xml/packet_fw_logo_iso_V4_T1.xml -p :%1:%2 %3_UPDATE_%2.BIN
merge.exe ./xml/packet_fw_logo_iso_V4_zip_T1.xml -p :%1:%2 %3_UPDATE_%2.ZIP
