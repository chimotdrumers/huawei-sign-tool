...
sign.exe ./xml/packet_fw_iso_webui_V4.xml -p %1 %2 %3 %5
...
merge.exe ./xml/packet_fw_iso_webui_V4.xml -p :%1:%2 %4_update_%2_%3.bin
merge.exe ./xml/packet_fw_iso_webui_V4_zip.xml -p :%1:%2 %4_update_%2_%3.zip
