...
@if not exist %FILE_NAME% goto usage7
set FILE_NAME=10-000a0000-Oeminfo.bin
@if not exist %FILE_NAME% goto usage7
set FILE_NAME=11-000b0000-CDROMISO.bin
@if not exist %FILE_NAME% goto usage7
...
@echo off
cd ../
.\IsohdGen.exe -v%3  -t./Images/10-000a0000-Oeminfo.bin

@REM Component signature first
@echo on
sign.exe ./xml/packet_fw_iso_webui_V4_T1.xml -p %1 %2 %3 %5
...
C:\Python25\python compress.py c ./Images/10-000a0000-Oeminfo.bin ./%ZLIB_FILE_TEMP%/10-000a0000-Oeminfo.zlib 9
C:\Python25\python compress.py c ./Images/11-000b0000-CDROMISO.bin ./%ZLIB_FILE_TEMP%/11-000b0000-CDROMISO.zlib 9
...
merge.exe ./xml/packet_fw_iso_webui_V4_T1.xml -p :%1:%2 %4_update_%2_%3.bin
merge.exe ./xml/packet_fw_iso_webui_V4_zip_t1.xml -p :%1:%2 %4_update_%2_%3.zip
...
@echo ####  Dashboard version- 	        %DASHBOARD_VER%
@echo ####  Web UI version- 	                %WEBUI_VER%
