...
sign.exe ./xml/packet_fw_logo_V4_T2.xml -p %1 %2
...
merge.exe ./xml/packet_fw_logo_V4_T2.xml -p :%1:%2 %3_UPDATE_%2.BIN
merge.exe ./xml/packet_fw_logo_V4_zip_T2.xml -p :%1:%2 %3_UPDATE_%2.ZIP
