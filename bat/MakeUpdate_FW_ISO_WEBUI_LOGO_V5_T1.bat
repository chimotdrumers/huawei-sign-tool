...
sign.exe ./xml/Make_FW_ISO_WEBUI_LOGO_V4_T1.xml -p %1 %2 %3 %4
...
merge.exe ./xml/Make_FW_ISO_WEBUI_LOGO_V4_T1.xml -p :%1:%2 %4_update_%2_%3.bin
merge.exe ./xml/Make_FW_ISO_WEBUI_LOGO_V4_zip_T1.xml -p :%1:%2 %4_update_%2_%3.zip
