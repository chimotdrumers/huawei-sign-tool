...
@ren *M3Image*.bin  03-00230000-M3Image_R11.bin
@ren *DTS*.bin  04-00270000-DTS_R11.bin
@ren *Kernel*.bin  05-00090000-Kernel_R11.bin
@ren *Modem*.bin  06-001e0000-Modem_fw.bin
...
sign.exe ./xml/packet_fw_iso_webui_logo_V4_T2.xml -p %1 %2 %3 %5
...
merge.exe ./xml/packet_fw_iso_webui_logo_V4_T2.xml -p :%1:%2 %4_update_%2_%3.bin
merge.exe ./xml/packet_fw_iso_webui_logo_V4_zip_T2.xml -p :%1:%2 %4_update_%2_%3.zip
