...
sign.exe ./xml/packet_fw_webui_v5_T2.xml -p %1 %2 %4
...
merge.exe ./xml/packet_fw_webui_v5_T2.xml -p :%1:%2 %3_UPDATE_%2.BIN
merge.exe ./xml/packet_fw_webui_V5_zip_T2.xml -p :%1:%2 %3_UPDATE_%2.ZIP
