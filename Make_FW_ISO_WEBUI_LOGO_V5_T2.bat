...
set FILE_PATH=bin
set FILE_FIRMWARE_PATH=%FILE_PATH%\FW_ISO_WEBUI_LOGO_V5_T2
...
call .\bat\MakeUpdate_FW_ISO_WEBUI_LOGO_V5_T2.bat %FILE_DLOAD_ID% %SOFTWARE_VER% %DASHBOARD_VER% %FILE_PRODUCT_NAME% %WEBUI_VER%